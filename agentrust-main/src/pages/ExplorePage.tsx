...
const staticAgents: Agent[] = [
  {
    ...
    capabilities: [
      { skillId: 50301, name: "DeFi Trading", active: true, requiresUserAuthorization: true },
      { skillId: 50302, name: "Arbitrage", active: true, requiresUserAuthorization: true },
      { skillId: 50303, name: "Liquidity Farming", active: false, requiresUserAuthorization: true },
    ],
  ...
  },
  {
    ...
    capabilities: [
      { skillId: 50311, name: "Liquidity Farming", active: true, requiresUserAuthorization: true },
      { skillId: 50312, name: "Yield Optimization", active: true, requiresUserAuthorization: true },
      { skillId: 50313, name: "Portfolio Rebalancing", active: false, requiresUserAuthorization: true },
    ],
    requiresUserAuthorization: true,
  },
  {
    ...
    capabilities: [
      { skillId: 50321, name: "Cross-chain Swaps", active: true, requiresUserAuthorization: true },
      { skillId: 50322, name: "MEV Protection", active: true, requiresUserAuthorization: true },
      { skillId: 50323, name: "Flash Loans", active: true, requiresUserAuthorization: true },
    ],
    requiresUserAuthorization: true,
  },
];
